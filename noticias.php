		...
		<a class="active" href="index.php">Principal</a>
			...
			<a href="vendedores.php">Vendedores</a>
	 		...
	 		<a href="tabelaprecos.php">Tabela de Preços</a>
	  		...
	  		<a href="tabeladiametros.php">Diâmetros das Bobinas</a>
...
<div class="container">
  ...
  <div class="row justify-content-center mb-5">
    <div class="col-sm-12 col-md-10 col-lg-8">
      <p><h4>04/11/2020 - Faturamento (Importante!!!)</h4></p>
      <div class="form-row">
        <h5>Todos os pedidos até o momento faturar somente na MAT</h5>
        <br>
        
        <h5>PF e PJ isento de IE que for gerar imposto fora do estado de SP, pode ser faturado na GERAR.
        </h5>
      </div>
      <hr>

      <!--<p><h4>26/10/2020 - Recebimento de Material P/ Semana</h4></p>
      <div>
        <h5>TNT Fiber Pink - 20 mil metros</h5>
      </div>
      <div>
         <h5>
          TNT Médio 8 Branco - 80 mil metros
        </h5>
      </div>  
      <hr> -->

       <p><h4>23/11/20 - 30 Gramas - Bobinas de 750 metros (BIATEX)</h4></p>
         <div>
        <h5>Recebimento de 336 mil metros. </h5>
      </div>

         <p><h4>17/11/20 - 30 Gramas - Bobinas de 500 metros (MAGMA)</h4></p>
         <div>
        <h5>SUFRAMA - R$ 1,03 (valor fixo e não há condições de desconto).</h5>
      </div>
        <div>
        <h5>Tabela 7% - R$ 1,14 </h5>
      </div>
        <div>
        <h5>Tabela 12% - R$ 1,14</h5>
      </div>
        <div>
        <h5>Os 30 Gramas de 750 metros da Biatex, segue os valores normais, conforme a tabela.</h5>
      </div>

          <hr>

        <p><h4>16/11/20 - Envio de Comprovantes - Disponível no Intranet</h4></p>
      <div>
        <h5>Não precisa mais enviar os comprovantes pelo whats, basta enviá-los através do intranet.</h5>
      </div>
            <hr>
       

        <p><h4>13/11/20 ou 16/11/20 - Recebimento de TNT PRETO (BIATEX)</h4></p>
      <div>
        <h5>Médio 8 PRETO - 30.000 (Bobinas de 250 Metros)</h5>
      </div>
            <hr>


      <p><h4>10/11/2020 - Recebimento de TNT PRETO e COLORIDO (BIATEX)</h4></p>
      <div>
        <h5>Fiber MARROM - 20.000 (Bobinas de 500 Metros).</h5>
      </div>
      <div>
         <h5>
          Fiber VERDE BANDEIRA - 50.000 (Bobinas de 500 Metros)
        </h5>
      </div> 
      <div>
         <h5>
          Medio 8 PRETO - 43.600 (Bobinas de 250 Metros)
        </h5>
      </div> 
       <div>
         <h5>
          Medio 6 PRETO - 57.400 (Bobinas de 350 Metros)
        </h5>
      </div>
      <hr>

 <p><h4>05/11/2020 - Recebimento de TNT PRETO (NEWTNT)</h4></p>
      <div>
        <h5>Fiber PRETO - 123.000 (Bobinas de 1500 Metros)</h5>
      </div>
      <div>
         <h5>
          Medio 6 PRETO - 32.000 (Bobinas de 500 Metros)
        </h5>
      </div> 
      <div>
         <h5>
          Medio 8 PRETO - 22.000 (Bobinas de 250 Metros)
        </h5>
      </div> 
      <hr>

      <p><h4>04/11/2020 - Preços do TNT 40 GR - Bobinas de 100 metros</h4></p>
      <div>
        <h5>R$ 1,27 - Tabela de 12%</h5>
      </div>
      <div>
         <h5>
          R$ 1,20 - Tabela de 7%
