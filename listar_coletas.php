...
$result_usuario = "SELECT * FROM coletas ORDER BY n_pedido DESC LIMIT $inicio, $qnt_result_pg";
...
<br>
		...
		<tbody>
			...
			while($row_usuario = mysqli_fetch_assoc($resultado_usuario)){
				...
				<tr>
					...
					<td><?php echo $row_usuario['n_nf']; ?></td>
					<!--<td>
						<?php

							echo date_format($date,'d-m-Y', strtotime('data_coleta'));
						?>
					</td> -->
					<td><?php echo $row_usuario['data_coleta']; ?></td> 
	...
	$result_pg = "SELECT COUNT(id) AS num_result FROM coletas";
