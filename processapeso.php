...
<div class="content">
    ...
    $bobinas = $_POST['bobinas'];
 	...
 	/*Cálculos*/
    $peso = $gramatura * $altura;
    $metros = $quantidade * $bobinas;
    $kilos = $metros * $peso;
    $total_volumes = $metros / $bobinas;
	?>
   	<!--Impressão de resultados-->
     <p>Peso Total: <?php echo "$kilos". " Kg"; ?></p>
     <p>Total de metros: <?php echo "$metros". " Mts"; ?></p>
     <p>Total de Volumes: <?php echo "$total_volumes"; ?></p>
  

     <p>Diâmetro das bobinas: <a href="tabeladiametros.php"> Clique aqui </a></p>
     
   <br>

<!--<a href="tabela_pesos.php">Voltar</a> -->

<input class="btn btn-primary font-weight-bold btn-md" type="button" value="Voltar" onClick="history.go(-1)">
